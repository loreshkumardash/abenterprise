...
class TCPDF {
	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			...
			$this->SetX($this->original_lMargin);
			//$this->MultiCell(0, 0, 'Plot.:House No 370/4218, Damana Square, Chandrasekharpur, Bhubaneswar, Odisha-751016,'."\n".'Ph. 0674-2549244, M: +91 7978178285, E : technofacilitymanagement.com, Web: www.technofacility.com', 'T', 0, 'C');
			//$this->MultiCell(0, 27, 'Plot.:House No 370/4218, Damana Square, Chandrasekharpur, Bhubaneswar, Odisha-751016,'."\n".'Ph. 0674-2549244, M: +91 7978178285, E : technofacilitymanagement.com, Web: www.technofacility.com.'."\n", 1, 'C', 2, 1, '', '', true, 0, false, true, 0);
			
			$this->writeHTMLCell(0, 0, '', '', 'Plot No-6/1124, Ranasinghpur, Behind Biju Patnaik State Police Academy, Pin - 751019,'."\n".'PH: +91- 94220 94221, E-mail: support@glosentindia.com'."\n", 0, 1, 0,true, "C", true);
		}
	}
	...
	public function FooterText() {
        ...
        // Page number
        $this->Cell(0, 0, 'page', 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
