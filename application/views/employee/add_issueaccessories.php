      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form role="form" action="<?php echo site_url("employee/add_issueaccessories");?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-2 form-group">
                      ...
                      <input type="text" name="employee_code" id="employee_code" class="form-control" placeholder="Employee Code" value="" required>
                    </div>
                    <div class="col-md-3 form-group">
                      <label for="employee_name">Employee Name</label>
                      <input type="text" name="employee_name" id="employee_name" class="form-control"  value="" readonly required>
                      <input type="hidden" name="employee_id" id="employee_id" class="form-control"  value="" readonly>
                    </div>
                    <div class="col-md-2 form-group">
                        ...
                        <tbody class="itemslist">
                          <tr>
                            <td>
                              ...
                              <option value="<?=$items[$i]['asset_id']?>" data-price="<?=$items[$i]['item_sale_price']?>"><?=$items[$i]['item_name']?></option>
                              <?php  }} ?>
                              </select>
                            </td>
                            <td>
                              <input type="text" name="item_price[]" class="form-control input-sm item_price" readonly="readonly">
                            </td>
                            <td>
                              
                              <input type="number" name="item_quantity[]" class="form-control input-sm item_quantity" min="1">
                            </td>
                            <td>
                              <input type="text" name="item_total_price[]" class="form-control input-sm item_total_price" readonly="readonly">
                  ...
                  <div class="row">
                    <div class="col-md-2 form-group">
                      ...
                      <input type="text" name="tot_amount" id="tot_amount" class="form-control"  value="0.00" readonly step="0.01">
                    </div>
                    <div class="col-md-2 form-group">
