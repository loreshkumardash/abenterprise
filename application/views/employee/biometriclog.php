        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Biometics Attendance Log</h3>
                </div>
            <!-- /.box-header -->
