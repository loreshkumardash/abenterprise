        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="<?php echo isset($activemenu) && $activemenu == 'users'? 'active' : ''?> treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li
                        class="<?php echo isset($activesubmenu) && $activesubmenu == 'add_menu_access'? 'active' : ''?>">
                    ...
                    <li
                        class="<?php echo isset($activesubmenu) && $activesubmenu == 'list_menu_access'? 'active' : ''?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url("lead/new_lead");?>"
                            class="nav-link <?=$submenu == 'new_lead' ? 'active' : ''?>"><i
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url("emp_leads");?>"
                            class="nav-link <?=$submenu == 'listleads' ? 'active' : ''?>"><i
                                class="fa fa-circle-o"></i>List Lead</a>
                    </li>
            ...
            <li class="<?php echo isset($activemenu) && $activemenu == 'leadreport'? 'active' : ''?> treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li
                        class="<?php echo isset($activesubmenu) && $activesubmenu == 'leadnotinterest'? 'active' : ''?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo site_url("lead/add_lead");?>"
                            class="nav-link <?=$submenu == 'multi_lead' ? 'active' : ''?>"><i
                                class="fa fa-circle-o"></i>Add Multiple Lead</a>
                    </li>
