                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="row" style="margin-top:3px;">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" id="so_name" name="so_name" placeholder="" >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="row" style="margin-top:3px;">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" id="based_at" name="based_at" placeholder="" >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="row" style="margin-top:3px;">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" id="reporting_to" name="reporting_to" placeholder="" >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                          ...
                          <table class="table table-bordered table-condensed table-striped">
                            ...
                            <tbody class="listitems">
                              <tr>
                                  ...
                                  <td width="45%">
                                   <input type="text" name="perticular[]" class="form-control" id="perticular" required="required"> 
                                    
                                  </td>
                                  <td width="20%">
                                    <input type="number" name="amount[]" class="form-control accessories" id="amount" required="required" >
                                  </td>
                                  <td width="10%">
                  ...
                  <div class="tab-content">
                      <div class="active tab-pane" id="paymentview">
                        ...
                        <tbody class="studentpaymentdata">
                           <?php if ($appointment) { for ($i=0; $i < count($appointment); $i++) {  ?>
                            <tr>
                              <td><?=$i+1;?></td>
                              <td><?=$appointment[$i]['name'];?></td>
                              <td><?=$appointment[$i]['so_name'];?></td>
                              <td><?=$appointment[$i]['dist'];?></td>
                              <td><?=$appointment[$i]['position'];?></td>
                              <td><?=$appointment[$i]['reporting_to'];?></td>
                              <td><?=$appointment[$i]['joining_date'];?></td>
                              <td> 
                              <a href="<?php echo site_url();?>/document/edit_appiontment/<?=$appointment[$i]['appointment_id'];?>" class="btn btn-warning btn-xs">edit</a>
                              <a href="<?php echo site_url();?>/document/delete_appiontment/<?=$appointment[$i]['appointment_id'];?>" onclick="return confirm('Are you sure to delete this?');" class="btn btn-danger btn-xs">delete</a>
                                <a href="<?=site_url('document/print_appointment/'.$appointment[$i]['appointment_id']);?>" class="btn btn-primary btn-xs" target=_blank><i class="fa fa-print"></i></a> 
                              </td> 
                           </tr>
                             <?php }} ?>  
                        </tbody>
