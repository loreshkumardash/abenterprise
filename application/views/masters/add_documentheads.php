          ...
          <div class="box">
            ...
            <div class="box-body">
            	<?php
	              ...
	              ?>
              	<form method="post" action="<?=site_url("masters/add_documentheads");?>" enctype="multipart/form-data">
              		<div class="col-md-4">
	                  <div class="row">
	                    
	                    <div class="col-md-12 form-group">
	                      <label for="dochead">Document Head</label>
	                      <input type="text" name="dochead" id="dochead" class="form-control" placeholder="Enter Document Name" value="" required>
	                    </div>
	                    <div class="col-md-12 form-group">
