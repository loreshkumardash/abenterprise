          ...
          <div class="box">
            ...
            <div class="box-body">
            	<?php
	              ...
	              ?>
              	<form method="post" action="<?=site_url("masters/add_transporter");?>" enctype="multipart/form-data">
              		<div class="col-md-4">
	                  <div class="row">
	                    
	                    <div class="col-md-12 form-group">
	                      <label for="transporter_name">Transporter Name</label>
	                      <input type="text" name="transporter_name" id="transporter_name" class="form-control" placeholder="Enter Transporter Name" value="" required>
	                    </div>
	                    <div class="col-md-12 form-group">
                	...
                	<div class="col-md-4">
	                  <div class="row">
	                    ...
	                    <div class="col-md-12 form-group">
	                      ...
	                      <input type="text" name="transporter_no" id="transporter_no" class="form-control" placeholder="Enter Transporter Id" value="" required>
	                    </div>
	                    <!-- <div class="col-md-12 form-group">
	                    ...
	                    <div class="col-md-12 form-group">
	                      ...
	                      <textarea name="transporter_address" id="transporter_address" class="form-control" rows="1" placeholder="Enter Address"></textarea>
	                    </div>
	                  </div>
                	</div>
                	<div class="col-md-12 form-group">
