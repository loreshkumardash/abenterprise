                  <table class="table table-condensed table-striped" cellpadding="2">
                    <tr>
                      <td width="70%"><span style="font-size:16px;"><b>GLOSENT</b></span></td>
                      <td width="30%"><b style="font-size:12px;">Group : <?=$group[0]['group_name'];?></b></td>
                    </tr>
                    <tr>
                      <td  width="70%"><span style="font-size:12px;"><b>Balance Sheet</b></span></td>
                  ...
                  <table id="tblexportData" class="table  table-condensed table-striped" cellpadding="2" style="font-size: 11px;">
                    ...
                    <tbody> 
                      ...
                      $ledg_creditasop = $this->Common_Model->db_query("SELECT SUM(cramount) as totcredit FROM entry_items as a LEFT JOIN entries as d on a.entry_id=d.entry_id LEFT JOIN ledgers as b on a.ledger=b.ledger_id LEFT JOIN under_group as c on b.acount_group=c.group_id WHERE  b.ledger_id=".$ledgers[$i]['ledger_id']." AND d.entry_dt < '".$fdate."'");
                        ...
                        <td width="15%"><?=$bal_type;?> <?=number_format($opening,2);?></td>
                      ...
                      <?php } }?>
                        ...
                        <tr style="background-color: #ddd;">
                          ...
                          <th width="15%"></th>
                          <th width="15%"><b>Dr <?=number_format($drtotal,2);?></b></th>
                          <th width="15%"><b>Cr <?=number_format($crtotal,2);?></b></th>
                          <th width="15%"></th>
                        </tr>
