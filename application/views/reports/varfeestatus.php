        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Variable Pay Fee Status</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6" style="padding-top: 15px;">
                  <button type="submit" formaction="<?php echo site_url("reports/varfeestatus");?>" name="submitBtn" value="submit" class="btn bg-navy btn-flat margin">Search</button>
                  <button type="submit" formaction="<?php echo site_url("reports/download_varfee_list");?>" name="submitBtn2" formtarget="_blank" value="submit" class="btn bg-navy btn-flat margin">Download</button>
                </div>
                </form>
              </div>
              <div class="row">
                <div class="col-md-12" id="dataTablediv">
                  ...
                  <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                      ...
                      <th><?php echo $students[$i]['total_fee'];?></th>
                      <th><?php echo $students[$i]['pending_fee'];?></th>
