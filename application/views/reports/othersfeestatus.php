                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Others Fee Status</h3>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="row">
                                ...
                                <form role="form" action="" method="post" id="searchForm">
                                    ...
                                    <div class="col-md-6" style="padding-top: 15px;">
                                        <button type="submit" formaction="<?php echo site_url("reports/othersfeestatus");?>" name="submitBtn" value="submit" class="btn bg-navy btn-flat margin">Search</button>
                                    </div>
                                </form>
                            </div>
                            <div class="row">
                                <div class="col-md-12" id="dataTablediv">
                                    ...
                                    <table class="table table-bordered table-condensed table-striped">
                                        ...
                                        $exists = db_query("SELECT * FROM student_othersfee WHERE student_id = ".$students[$i]['student_id']." AND admission_id = ".$students[$i]['admission_id']);
                                        if($exists){
                                        ?>
                                        <tr>
                                        ...
                                        if($months){
                                            foreach ($months as $month) {
                                            $feelist = db_query("SELECT * FROM student_othersfee WHERE month_year = '".$month['monthyear']."' AND  student_id = ".$students[$i]['student_id']." AND admission_id = ".$students[$i]['admission_id']);
                                                if($feelist){
                                                    $tdclass = '';
                                                    $amount = 0;
                                                    $status = '';
