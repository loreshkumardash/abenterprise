        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Trial Balance Details</h3>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="float-right">
                        <a href="<?=site_url('reports/trialbalanceledger_pdf/'.$group[0]['group_id'].'/'.$fdate.'/'.$ldate);?>" class="btn btn-primary btn-sm" style="width: 9rem;" target="_blank">Print as Pdf</a>
                      <a href="<?=site_url('reports/trialbalanceledger_excel/'.$group[0]['group_id'].'/'.$fdate.'/'.$ldate);?>" class="btn btn-warning btn-sm" style="width: 9rem;">Print as Excel</a>  
                    </div>
                  </div>
                  ...
                  <table id="tblexportData" class="table  table-condensed table-striped">
                    ...
                    <tbody> 
                      <?php if ($ledgers) { $drtotal =0;$crtotal =0; for ($i=0; $i < count($ledgers); $i++) { 
                        ...
                        <td width="15%"><?php if ($category[0]['category_id']==1 || $category[0]['category_id']==4) {
                              echo 'Dr';
