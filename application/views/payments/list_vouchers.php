  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<div class="col-md-2">
                  <div class="form-group">
                    <label for="payment_date_to">Voucher No</label>
                    <input type="text" class="form-control" id="voucher_no" name="voucher_no" value="<?php echo set_value("voucher_no");?>">
                  </div>
                </div>

                <div class="col-md-4" style="margin:5px auto; padding-top: 20px;">
                  <button type="submit" class="btn bg-navy btn-flat" formmethod="get" formaction="<?=site_url("payments/list_vouchers");?>">Search</button>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number"><?=$voucher[0]['cashvoucher'];?></span>
                      <span class="info-box-text">Cheque Voucher</span>
                      <span class="info-box-number"><?=$voucher[0]['chequevoucher'];?></span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Bank Deposite</span>
                      <span class="info-box-number"><?=$voucher[0]['bankdeposite'];?></span>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number"><?=$voucher[0]['expense'];?></span>
                      <span class="info-box-text">Collection</span>
                      <span class="info-box-number"><?=$voucher[0]['collection'];?></span>
                    </div>
                  </div>
                </div>
                <div class="col-md-12" id="dataTablediv">
                  ...
                  <table width="100%" class="table table-condensed table-small-font table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <th data-priority="1">Voucher No</th>
                      <th data-priority="1">Date</th>
                      <th data-priority="1">Approved Date</th>
                  ...
                  <tbody class="font11">
                    <?php if($records){ for($i=0;$i<count($records);$i++){
                        ...
                        if ($records[$i]['unit_id'] > 0) {
                        $unit = $this->Common_Model->FetchData("units","*","unit_id=".$records[$i]['unit_id']);
                      }
                    ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo site_url("payments/print_voucher/".$records[$i]['voucher_id']);?>" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></a>
                      </td>
                      <td><?php echo $records[$i]['voucher_no'];?></td>
                      <td><?php echo date("d/m/Y", strtotime($records[$i]['payment_date']));?></td>
                      <td><?=$records[$i]['approved_on']? ''.date("d/m/Y", strtotime($records[$i]['approved_on'])).'':'--';?></td>
